    ...
    <div id="templatemo_content">
    	<div id="templatemo_main_content">
        	...
        	<div class="content_box">
				<form method="post" action="academia.php">
				<p><b style="position:relative;left:2%;display:inline;">Institution:</b><input type="text" name="institution" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Class:</b><input type="text" name="class" style="position:relative;float:right;right:40%;"></p>
				...
				<p><b style="position:relative;left:2%;display:inline;">Admission Number:</b><input type="text" name="admNo" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Total Fees:</b><input type="text" name="totalFees" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Paid:</b><input type="text" name="paid" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Balance:</b><input type="text" name="balance" style="position:relative;float:right;right:40%;"></p>
