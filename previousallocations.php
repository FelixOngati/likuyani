    ...
    <div id="templatemo_content">
    	<div id="templatemo_main_content">
        	...
        	<div class="content_box">
				<form method="post" action="previousallocations.php">
				<p><b style="position:relative;left:2%;display:inline;">Bursary Type:</b><input type="text" name="bursary" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Date Awarded:</b><input type="text" name="dateAwarded" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Amount:</b><input type="text" name="amount" style="position:relative;float:right;right:40%;"></p>
