    ...
    <div id="templatemo_content">
    	<div id="templatemo_main_content">
        	...
        	<div class="content_box">
				...
				<p><b style="position:relative;left:2%;display:inline;">Allocation ID:</b><input type="text" name="allocationId" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Bursary Name:</b><input type="text" name="bursaryName" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">Date:</b><input type="text" name="date" style="position:relative;float:right;right:40%;"></p>
				<p><b style="position:relative;left:2%;display:inline;">P ID:</b><input type="text" name="pId" style="position:relative;float:right;right:40%;"></p>
